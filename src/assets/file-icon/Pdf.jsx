    ...
    >
      <g fill="none">
        ...
        <defs>
          ...
          >
            <stop stopColor="#E95C56"></stop>
            <stop offset={1} stopColor="#D93025"></stop>
          </linearGradient>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#F7B7B4"></stop>
            <stop offset={1} stopColor="#FAD8D7"></stop>
          </linearGradient>
          <linearGradient
          ...
          <radialGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.362} stopColor="#8B1F1B"></stop>
            <stop offset={1} stopColor="#8B1F1B" stopOpacity={0}></stop>
          </radialGradient>
        </defs>
      </g>
    </svg>
