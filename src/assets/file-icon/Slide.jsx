    ...
    >
      <g fill="none">
        ...
        <defs>
          ...
          >
            <stop stopColor="#faef66"></stop>
            <stop offset={1} stopColor="#ffac05"></stop>
          </linearGradient>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#ffec75"></stop>
            <stop offset={1} stopColor="#fffbca"></stop>
          </linearGradient>
          <linearGradient
          ...
          <radialGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.362} stopColor="#b1bc00"></stop>
            <stop offset={1} stopColor="#b1bc00" stopOpacity={0}></stop>
          </radialGradient>
        </defs>
      </g>
    </svg>
