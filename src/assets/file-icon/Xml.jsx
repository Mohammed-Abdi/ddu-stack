    ...
    >
      <g fill="none">
        ...
        <defs>
          ...
          >
            <stop stopColor="#45A459"></stop>
            <stop offset={1} stopColor="#188038"></stop>
          </linearGradient>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#ABDCAE"></stop>
            <stop offset={1} stopColor="#D4E8D7"></stop>
          </linearGradient>
          <linearGradient
          ...
          <radialGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.362} stopColor="#0F4B23"></stop>
            <stop offset={1} stopColor="#0F4B23" stopOpacity={0}></stop>
          </radialGradient>
        </defs>
      </g>
    </svg>
